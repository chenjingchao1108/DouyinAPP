package com.mrc.douyinapp.home.recommend.model;


import com.mrc.douyinapp.home.recommend.bean.BannerBeanlist;
import com.mrc.douyinapp.home.recommend.bean.RecommendBean;
import com.mrc.douyinapp.home.recommend.presenter.IHomePre;
import com.mrc.douyinapp.home.recommend.utils.RetiofitVip;
import com.mrc.douyinapp.home.recommend.utils.RetrofitHelper;
...
public class HomeModel {
    ...
    public void getHomeBanner(final IHomePre iHomePre) {
        ...
        retiofitVip.homeBanner("1128","no_retry","24667239392","34971691517")
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
